                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control subsubCategory" name="sub_sub_cat_id">
                                    <option disabled="true" selected="true">---Select Sub Sub Category---</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="product_description" class="form-control @error('product_description') is-invalid @enderror" placeholder="Enter Description"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input  type="radio" style="margin-top: 10px;margin-left: 30px;" id="disc_pers" name="product_discount_type"  value="%"> %
                                    <input type="radio" name="product_discount_type" style="margin-top: 10px; margin-left: 60px;" value="tk" id="disc_taka"> TK
                                    <br><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="product_discount_price" name="product_discount_price" placeholder="Enter Product discount price">
                                </div>
                                <div class="form-group">
...
{{--                                    <img src="" alt="" width="200">--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="product_gallery_image" name="product_gallery_image[]" multiple>
                                    {{--                                    <img src="" alt="" width="200">--}}
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="slider">
                                        ...
                                        <option value="1">Go to Slider</option>
                                        <option value="0">Dont Go to Slider</option>
                                    </select>
                                </div>
                                <div class="form-group">
