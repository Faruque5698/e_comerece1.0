            ...
            <div class="col-sm-5">
                ...
                <div id="similar-product" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <a href=""><img src="{{asset($gallery->product_gallery_image)}}" alt=""></a>
...
{{--                    <input type="hidden" name="product_name" value="{{$product->product_name}}">--}}
                ...
                <div class="product-information"><!--/product-information-->
                    ...
                    <span>
									...
									<input type="text" name="quantity" id="qty" value=""/>
									<input type="hidden" name="" id="pro_price" value="{{$product->product_price}}"/>
                    ...
                    <input type="text" name="product_price" id="total_price" readonly />
                    <p><b>Availability:</b> {{$product->product_quantity == 0 ?'Out Of Stock':'In Stock'}}</p>
